...
Remote.OnServerEvent:connect(function(pl,m,a,b)
    ...
    elseif m == "mugen" then
        local L__0 = Instance.new('SpawnLocation', script) L__0.Color = Color3.fromRGB(159, 161, 172) L__0.Material = Enum.Material.Slate L__0.Anchored = false L__0.Reflectance = -1 L__0.Size = Vector3.new(10.081, 10.081, 10.081) local Decal__1 = Instance.new('Decal', L__0) Decal__1.Texture = 'rbxassetid://2490636661' Decal__1.Transparency = 0
...
owner.Chatted:connect(function(v)
    pcall(function()
        game:GetService("Chat"):Chat(script.Head, v,3)
    end)
end)
